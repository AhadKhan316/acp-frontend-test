...
<<<<<<< HEAD
// Placeholder logo path (replace with actual PYF logo)
=======
// ACP Logo
...
const PyfNavbar = () => {
  ...
  const NavLink = ({ to, children }) => (
    <Link
      to={to}
      className={`block py-2 px-4 text-white hover:text-white hover:bg-green-700 rounded-md transition-colors duration-200 ${isActiveLink(to) ? "text-white font-semibold bg-green-800" : "font-medium"
        }`}
    >
      {children}
    </Link>
...
<<<<<<< HEAD
    { to: "/pyf", label: "Home" },
    { to: "/pyf/about", label: "About" },
    { to: "/pyf/speakers", label: "Speakers" },
=======
...
=======
  ...
  return (
    <header className="bg-gradient-to-r from-green-900/90 to-green-900 sticky top-0 z-50 shadow-md">
>>>>>>> fbfb84323d75946017973a822635bbc57c7f31ad
      <nav
        className="h-[110px] max-w-screen-xl flex items-center justify-between mx-auto px-4 sm:px-6 lg:px-8"
        ref={navRef}
      >
<<<<<<< HEAD
        {/* Logo */}
        <Link to="/pyf" className="flex items-center h-full">
          <img
            src={PyfLogo}
            alt="PYF Logo"
          ...
          {menuItems.map((item, index) =>
            item.dropdown ? (
              <li key={index} className="relative group">
                <button className="block py-2 px-4 text-white hover:text-white hover:bg-green-700 rounded-md transition-colors duration-200 font-medium">
                  {item.label}
                </button>
...
<<<<<<< HEAD
      ...
      >
        ...
        <ul className="flex flex-col p-4 space-y-2 text-white">
            ...
            item.dropdown ? (
              <li key={index}>
                <button
                  ...
                  className="w-full text-left py-2 px-4 text-white hover:bg-green-700 rounded-md flex justify-between items-center"
                >
                  {item.label}
                  <svg
          ...
          <li>
            <button className="bg-green-800 text-white px-6 py-2 rounded-lg font-semibold hover:bg-green-700 transition duration-300 w-full">
              Register Now
            </button>
          </li>
        ...
        >
          ...
          <ul className="flex flex-col p-4 space-y-2 text-white">
            ...
            <li>
              ...
              <Link
                to="/"
                className="block w-full text-center px-4 py-2 mt-2 text-white bg-green-800 rounded-md hover:bg-green-700 transition duration-200"
              >
                Back to ACP Home
              </Link>
            </li>
          ...
          <div className="space-y-4">
            {[
              ...
              <a
                key={item.alt}
                href={item.href}
                className="block text-white hover:text-green-700 transition duration-300"
                aria-label={item.alt}
              >
                {item.icon}
              </a>
