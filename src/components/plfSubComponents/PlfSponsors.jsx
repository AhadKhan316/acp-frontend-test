  ...
  return (
    <section className="py-8 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-2xl sm:text-4xl font-bold text-green-900 mb-4">
            Our Sponsors
          </h2>
            ...
            <div className="flex justify-center mt-12 space-x-2">
              {Array.from({ length: maxIndex + 1 }).map((_, idx) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full transition-all ${currentIndex === idx ? 'bg-gradient-to-r from-green-700 to-green-500 w-8' : 'bg-gray-200'}`}
