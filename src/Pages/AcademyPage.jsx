...
const AcademiesPage = () => {
  const academyData = [
    ...
    { id: 4, name: "Textile Design", image: departmentImg1, route: "textile-design" },
    { id: 5, name: "Theatre", image: departmentImg2, route: "theatre" },
    { id: 6, name: "Music", image: departmentImg3, route: "music" },
  ];
